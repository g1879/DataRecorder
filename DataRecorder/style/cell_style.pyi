...
class CellFont(object):
    ...
    def set_color(self, color: Optional[str, tuple, Color]) -> None: ...
...
class CellBorder(object):
    ...
    def set_start(self, style: LINES, color: Optional[str, tuple, Color]) -> None: ...

    def set_end(self, style: LINES, color: Optional[str, tuple, Color]) -> None: ...

    def set_left(self, style: LINES, color: Optional[str, tuple, Color]) -> None: ...

    def set_right(self, style: LINES, color: Optional[str, tuple, Color]) -> None: ...

    def set_top(self, style: LINES, color: Optional[str, tuple, Color]) -> None: ...

    def set_bottom(self, style: LINES, color: Optional[str, tuple, Color]) -> None: ...

    def set_diagonal(self, style: LINES, color: Optional[str, tuple, Color]) -> None: ...

    def set_vertical(self, style: LINES, color: Optional[str, tuple, Color]) -> None: ...

    def set_horizontal(self, style: LINES, color: Optional[str, tuple, Color]) -> None: ...
...
class CellPatternFill(object):
    ...
    def set_fgColor(self, color: Optional[str, tuple, Color]) -> None: ...

    def set_bgColor(self, color: Optional[str, tuple, Color]) -> None: ...
